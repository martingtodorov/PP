...
- **404 → каталог, но с твърд 404.** Статусът остава 404 (+`noindex`), а човекът се праща към
  каталога след 3 секунди: `<meta http-equiv="refresh" content="3;url=…">` в SSR-а и таймер в
  `NotFoundBlock`, с надпис „Пращаме те към каталога след 3 секунди…“ (11 езика). Добавен е и
  catch-all маршрут `path="*"` в App.js, защото досега непознат URL даваше празна страница.
